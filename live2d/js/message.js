...
if(!norunFlag){
	...
	$(document).ready(function() {
		var AIimgSrc = [
			home_Path + message_Path + "model/histoire/histoire2/texture_00.png",
			home_Path + message_Path + "model/histoire/histoire2/texture_01.png",
			home_Path + message_Path + "model/histoire/histoire2/texture_02.png",
			home_Path + message_Path + "model/histoire/histoire2/texture_03.png"
		]
		var images = [];
